...
- Proposez un merge request / pull request avec une description claire des changements.

**Licence**
- Aucune licence fournie. Ajoutez un fichier LICENSE si vous souhaitez en imposer une.

Si vous voulez, je peux: ajouter des instructions d'export, préciser la version de Godot, ou générer un fichier LICENSE (MIT/Apache/etc.).
